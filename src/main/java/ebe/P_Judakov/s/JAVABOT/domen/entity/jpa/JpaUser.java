...
@Entity
@Table(name = "user")
public class JpaUser implements ebe.P_Judakov.s.JAVABOT.domen.entity.interfaces.User {
    @Id
    ...
    public JpaUser(int id, String username, String firstName, String lastName, String stockTicker, List<JpaChat> jpaChats, List<JpaMessage> messages) {
        this.id = id;
        this.username = username;
        this.firstName = firstName;
        this.lastName = lastName;
        this.stockTicker = stockTicker;
        this.jpaChats = jpaChats;
